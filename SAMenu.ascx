<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SAMenu.ascx.cs" Inherits="systemAdmin.SAMenu" %>
...
<nav class="navbar navbar-expand-md bg-light navbar-light">
    ...
    <div class="collapse navbar-collapse" id="staffNavbar">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="ViewingRequest.aspx">Viewing Request</a>
            </li>
        </ul>
